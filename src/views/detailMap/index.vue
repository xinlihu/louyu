                            ...
                            <div class="top-body">
                                <div class="top-left">
                                    <div class="top-left-title">
                                        ...
                                        <img src="../../api/images/pictre.png" alt="">
                                    </div>
...
<script src="../../api/js/china.js"></script>
...
<script>
    export default {
        ...
        nowTime = myYear+'年'+this.fillZero(myMonth)+'月'+this.fillZero(myToday)+'日'+'&nbsp;&nbsp;'+this.fillZero(myHour)+':'+this.fillZero(myMinute)+':'+this.fillZero(mySecond)+'&nbsp;&nbsp;'+week[myDay]+'&nbsp;&nbsp;';
        //console.log(nowTime);
        $('#time').html(nowTime);
        },
        fillZero(str){
